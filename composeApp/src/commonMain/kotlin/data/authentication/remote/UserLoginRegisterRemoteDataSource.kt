...
interface UserLoginRegisterRemoteDataSource {
    suspend fun loginUserWithIdpToken(authenticationUserModel: AuthenticationUserModel): CheckResult<AuthenticationInfoDto, DataError.Network, ErrorResponseDto>
    suspend fun loginUserWithPassword(authenticationUserModel: AuthenticationUserModel): CheckResult<AuthenticationInfoDto, DataError.Network, ErrorResponseDto>
